...
void login()
{
	...
	b1.addActionListener(new ActionListener()
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			try
			{
			BufferedReader file=new BufferedReader(new FileReader("C:/java mini project/projectfile.txt"));
...
void signUp()
{
	...
	b1.addActionListener(new ActionListener()
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			int z=0;
			try{
			//BufferedReader br2=new BufferedReader(new FileReader("C:/java mini project/gmailfile.txt"));
			//String y=br2.readLine();
			int q=s2.indexOf("@");
			String r="@gamil.com";
			String p=s3.substring(q,10); 
			//while(!y.equals(null))
			//{
				if(p.equals(r))
				{
			z=1;
 			BufferedWriter br=new BufferedWriter(new FileWriter("C:/java mini project/projectfile.txt",true));
			br.write(s2+" "+s4);
			br.newLine();
			br.close();
			c.city();
...
void city()
{
	...
	b10.addActionListener(new ActionListener()
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			try
			{ 
			BufferedReader file=new BufferedReader(new FileReader("C:/java mini project/cityfile.txt"));
			String x=file.readLine();
			while(!x.equals(null))
			{
				if(x.equals(s1))
			...
			if(z==0)
			{
			Lable l49=new Label("invalid city name");
			l49.setBounds(600,100,400,50);
			l49.setFont(font);
			f4.add(l49);
			}
		}
...
{                   
	...
	f5.setLayout(null);
	try{
	BufferedImage j=ImageIO.read(new File("C:/java mini project/2.0.JPG"));
...
void booking()
{
	...
	b13.addActionListener(new ActionListener()
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			try
			{
			BufferedReader file=new BufferedReader(new FileReader("C:/java mini project/theatrefile.txt"));
			String x=file.readLine();
			while(!x.equals(null))
			{
				if(x.equals(s1))
			...
			if(z==0)
			{
			Label l50=new Label("the required movie is not there in that theatre");
			l50.setBounds(250,300,700,50);
			l50.setFont(font);
			f6.add(l50);
			}
		}
...
void available()
{
	...
	t16.setFont(font);
	f8.add(t16);
	Button b50=new Button("Buy");
	b50.setBounds(750,400,100,50);
	b50.setFont(font);
	Tqs tq=new Tqs();
	Sorry sr=new Sorry();
	int x=300;
